...
\cvtag{SpringBoot}\cvtag{Angular}\cvtag{Mockito}\cvtag{SonarQube}
...
\cvachievement{\faTrophy}{Encadrement de stagiaire}{Accompagnement d'un stagiaire lors de son stage de fin d'étude chez Artik.}
\cvachievement{\faTrophy}{Un jeune TechLead}{ Après une année couronnée de succès sur ma première mission chez La Poste, j'ai eu le rôle de Techlead dans une équipe composée de 6 développeurs }
